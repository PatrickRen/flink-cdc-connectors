...
public class RecordUtils {
    ...
    public static Map<String, String> createSourceOffsetMap(final BsonDocument idDocument) {
        Map<String, String> sourceOffset = new HashMap<>();
        sourceOffset.put(ID_FIELD, idDocument.toJson());
        return sourceOffset;
    }

    public static Map<String, String> createSourceOffsetMapForSnapshotRecord(
            final BsonDocument idDocument, ChangeStreamOffset offset) {
        Map<String, String> sourceOffset = createSourceOffsetMap(idDocument);
        sourceOffset.put(COPY_KEY_FIELD, "true");
        sourceOffset.put(RESUME_TOKEN_FIELD, offset.getOffset().get(RESUME_TOKEN_FIELD));
        sourceOffset.put(TIMESTAMP_FIELD, offset.getOffset().get(TIMESTAMP_FIELD));
        return sourceOffset;
    }
