...
public class MongoDBStreamFetchTask implements FetchTask<SourceSplitBase> {
    ...
    public void execute(Context context) throws Exception {
        ...
        openChangeStreamCursor(taskContext.getChangeStreamDescriptor());
                ...
                if (!next.isPresent()) {
                    ...
                    sourceRecords.add(
                            createSourceRecord(
                                    ...
                                    createSourceOffsetMap(valueDocument.getDocument(ID_FIELD)),
    ...
    private void openChangeStreamCursor(ChangeStreamDescriptor changeStreamDescriptor) {
        ...
        try {
            ...
            if (e.getErrorCode() == FAILED_TO_PARSE_ERROR
                ...
                if (e.getErrorMessage().contains("startAtOperationTime")) {
                    ...
                    openChangeStreamCursor(changeStreamDescriptor);
