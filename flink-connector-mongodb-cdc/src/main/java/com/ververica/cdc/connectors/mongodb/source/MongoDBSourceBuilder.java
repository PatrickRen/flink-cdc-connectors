...
public class MongoDBSourceBuilder<T> {
    ...
    public MongoDBSourceBuilder<T> copyExisting(boolean copyExisting) {
        this.configFactory.copyExisting(copyExisting);
        return this;
    }
     ...
     */
    public MongoDBSourceBuilder<T> copyExistingQueueSize(int copyExistingQueueSize) {
        this.configFactory.copyExistingQueueSize(copyExistingQueueSize);
        return this;
    }
     ...
     */
    public MongoDBSourceBuilder<T> chunkSizeMB(int chunkSizeMB) {
        this.configFactory.chunkSizeMB(chunkSizeMB);
        return this;
    }
