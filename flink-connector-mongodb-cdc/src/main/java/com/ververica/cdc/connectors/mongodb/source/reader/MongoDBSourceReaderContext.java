 ...
 * MongoDBSourceReader} and {@link MongoDBSourceSplitReader}.
 */
public class MongoDBSourceReaderContext {

    private final SourceReaderContext sourceReaderContext;
    private volatile boolean stopStreamSplitReader;

    public MongoDBSourceReaderContext(final SourceReaderContext sourceReaderContext) {
