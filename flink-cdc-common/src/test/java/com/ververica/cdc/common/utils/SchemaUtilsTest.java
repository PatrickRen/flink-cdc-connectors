...
public class SchemaUtilsTest {
    ...
    public void testApplySchemaChangeEvent() {
        ...
        schema = SchemaUtils.applySchemaChangeEvent(addColumnEvent, schema);
        Assert.assertEquals(
                schema,
                Schema.newBuilder()
                        .physicalColumn("col1", DataTypes.STRING())
        ...
        DropColumnEvent dropColumnEvent =
                new DropColumnEvent(
                        ...
                        Arrays.asList(
                                Column.physicalColumn("col3", DataTypes.STRING()),
                                Column.physicalColumn("col5", DataTypes.STRING())));
        schema = SchemaUtils.applySchemaChangeEvent(dropColumnEvent, schema);
        Assert.assertEquals(
                schema,
                Schema.newBuilder()
                        .physicalColumn("col0", DataTypes.STRING())
        ...
        schema = SchemaUtils.applySchemaChangeEvent(renameColumnEvent, schema);
        Assert.assertEquals(
                schema,
                Schema.newBuilder()
                        .physicalColumn("col0", DataTypes.STRING())
        ...
        schema = SchemaUtils.applySchemaChangeEvent(alterColumnTypeEvent, schema);
        Assert.assertEquals(
                schema,
                Schema.newBuilder()
                        .physicalColumn("col0", DataTypes.STRING())
